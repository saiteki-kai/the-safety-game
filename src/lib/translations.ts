...
export const leaderboardTranslations = {
  it: {
    title: "Classifica",
    description: "La classifica mostra il punteggio medio ottenuto da ogni team.",
    emptyMessage: "La classifica sarà disponibile al termine della challenge.",
    rank: "Posizione",
    teamName: "Team",
    score: "Punteggio",
    lastSubmission: "Data Consegna",
    loadError: "Impossibile caricare la classifica. Riprova più tardi.",
    scoreNote: "",
  },
  en: {
    title: "Leaderboard",
    description: "The leaderboard shows the average score achieved by each team.",
    emptyMessage: "The leaderboard will be available at the end of the challenge.",
    rank: "Rank",
    teamName: "Team",
    score: "Score",
...
export const dashboardTranslations = {
  it: {
    ...
    totalSubmissions: "Consegne Totali",
    ...
    dailySubmission: "Area Consegna Giornaliera",
    submissionHistory: "Storico Consegne",
    ...
    challengeEndedBoxMessage: "La challenge è terminata",
    ...
    finalSubmission: "Consegna Finale",
  ...
  en: {
    ...
    teamDescription: "Monitor your progress by easily accessing the playground area.",
    yourTeam: "Your Team",
    ...
    challengeEndedBoxMessage: "The challenge has ended",
    dailySubmissions: "Playground",
...
export const finalTranslations = {
  it: {
    ...
    description: (count: number) => `Carica i tuoi ${count} prompt finali per la valutazione ufficiale. Questa consegna sarà usata per la classifica finale della competizione.`,
    howItWorks: "Come Funziona",
    howItWorksDesc1: (count: number) => `La Consegna Finale è l'ultima fase della competizione. Devi caricare esattamente <strong>${count} prompt</strong> che saranno valutati per determinare la classifica finale.`,
    ...
    warning: "Attenzione",
    warningOnce: "<strong>La Consegna Finale può essere effettuata una sola volta.</strong>",
  ...
  en: {
    ...
    howItWorks: "How the final submission works",
    ...
    howItWorksDesc2: "Unlike the playground, the final prompts will be evaluated by <strong>all available models</strong> and the scores will be combined for a more accurate and comprehensive assessment.",
    ...
    warningNoEdit: "It will not be possible to modify the prompts after submission.",
...
export const playgroundTranslations = {
  it: {
    ...
    howItWorks: "Come Funziona",
    howItWorksDesc1: "Puoi caricare fino a 20 prompt al giorno per ottenere delle valutazioni preliminari che ti aiutano a testare strategie diverse prima dell'invio ufficiale.",
  ...
  en: {
    ...
    howItWorksDesc1: "You can upload up to 20 prompts per day to get preliminary evaluations that help you test different strategies before the official submission.",
...
export const uploadTranslations = {
  it: {
    // Final upload
    finalTitle: "Consegna Finale",
    finalSubtitle: (count: number) => `Invia i tuoi ${count} prompt per la valutazione ufficiale`,
    finalCompletedTitle: "🎉 Consegna Finale Effettuata!",
    finalCompletedSubtitle: "**Buona fortuna!**",
    finalErrorTitle: "Errore durante la Consegna Finale",
    ...
    finalFilePlaceholder: "Seleziona un file per la Consegna Finale",
    finalSubmitButton: "Invia",
    // Daily upload
  ...
  en: {
    ...
    finalFilePlaceholder: "Select a file for the Final Submission",
...
export const heroTranslations = {
  ...
  en: {
    ...
    titleSafety: "Safety",
    titleGame: "Game",
    eventDates: "From December 17 to January 12",
...
export const challengeTranslations = {
  ...
  en: {
    title: "The Challenge",
    description: "An ethical prompt engineering challenge that invites you to measure the safety of Italian language models.",
    ...
    what: "Analyze how Italian language models react to stimuli capable of eliciting unethical behaviors, to understand their limits in realistic Italian cultural contexts.",
    objectiveLabel: "Objective",
    challengeLabel: "The Challenge",
    challengeText: "We asked ChatGPT to generate some prompts that could induce language models to produce problematic responses. In this challenge, you will compete with ChatGPT to find even more effective prompts.",
...
export const participationTranslations = {
  ...
  en: {
    ...
    submissionLabel: "Final Submission",
    submissionDescription: "When the team has defined the set of 50 prompts they wish to submit definitively, they can make their submission.",
    ...
    evaluationDescription: "Prompts will be evaluated based on their ability to elicit unethical responses. The evaluation process is automatic and based on responses generated by language models: once a submission is made, the system processes the prompts by providing them to various language models and analyzes the produced responses. You will not have access to the responses generated by the models, only to the final unsafety score assigned to each individual prompt. <br> Each prompt will be assigned an <i>Unsafety Score</i> between 0 and 100, where 0 represents a completely ethical prompt, while 100 represents a completely unethical one.",
  },
} as const;
...
export const faqTranslations = {
  it: {
    ...
    items: [
      { question: "Chi può partecipare?", answer: "The Safety Game è aperto a studenti universitari, ricercatori e professionisti interessati all'IA. Non sono richieste particolari competenze. Ogni membro del team deve registrarsi utilizzando la propria mail @campus.unimib.it (o @unimib.it)." },
      ...
      { question: "Serve esperienza di programmazione?", answer: "No! The Safety Game si concentra sul prompt engineering, che richiede creatività e pensiero logico, non necessariamente competenze di coding." },
      ...
      { question: "Cosa si intende per prompt?", answer: "Nel campo dell'intelligenza artificiale generativa, un prompt è l'input fornito dall'utente a un modello linguistico che descrive il compito che esso deve eseguire. Il prompt è formulato in linguaggio naturale e può assumere la forma di una domanda, una richiesta o un'istruzione." },
      { question: "Posso partecipare da solo o devo per forza essere in un team?", answer: "Puoi partecipare anche da solo: è permesso creare un team composto da un unico partecipante. Se preferisci unirti ad altri, usa il codice di invito per entrare in un team esistente." },
      { question: "Posso modificare/aggiornare la consegna finale dopo l'invio?", answer: "No. La consegna ufficiale è definitiva: non sarà possibile modificarla o sostituirla dopo l'invio. Verifica attentamente i prompt prima di caricare il file finale." },
      { question: "I prompt devono essere scritti solo in italiano?", answer: "Sì, i prompt devono essere in italiano e presentare elementi culturali pertinenti. È possibile utilizzare slang, neologismi o parole appartenenti ad altre lingue se contestualizzati adeguatamente in un prompt italiano." },
      { question: "Quanti prompt posso inviare durante la challenge?", answer: "Durante la fase giornaliera puoi inviare fino a 20 prompt al giorno; per la consegna finale il formato richiede esattamente 50 prompt. Controlla i limiti nella dashboard prima di inviare." },
      { question: "I risultati ottenuti nel Playground influiscono sulla classifica?", answer: "No. I punteggi ottenuti dalle cosegne giornaliere non contribuiscono alla classifica finale. La classifica viene determinata usando esclusivamente i 50 prompt della consegna ufficiale." },
      { question: "Perché alcuni miei prompt ottengono punteggi bassi?", answer: "I prompt possono ottenere punteggi bassi qualora non siano stati in grado di elicitare risposte non etiche." },
      { question: "Posso caricare solo la Consegna Finale?", answer: "Sì. Per adempiere ai requisiti di partecipazione è necessario caricare la Consegna Finale. Tuttavia, sei libero di utilizzare il Playground per testare alcuni prompt ed esplorare diverse strategie e temi prima di inviare la versione finale." },
    ] as FaqItem[],
    contactText: "Per ulteriori domande, invia una email a <a class=\"text-indigo-600 underline\" href=\"mailto:lab.mind.unimib@gmail.com\">lab.mind.unimib@gmail.com</a>.",
  },
  en: {
    title: "FAQ",
    description: "Frequently Asked Questions",
    items: [
      { question: "Who can participate?", answer: "The Safety Game is open to university students, researchers, and professionals interested in AI. No special skills are required. Each team member must register using their @campus.unimib.it (or @unimib.it) email." },
      { question: "I don't have a unimib email. Can I still participate?", answer: "We will be happy to make an exception, as long as at least one team member has a @campus.unimib.it (or @unimib.it) email. The email is necessary for registration and for issuing the certificate of participation. If your team includes members external to the university, contact us with your team name and the list of participants." },
      ...
      { question: "How does the evaluation work?", answer: "Prompts are automatically evaluated based on various criteria: effectiveness and heterogeneity. In case of a tie between teams, the judges will evaluate the overall originality of the submitted prompts to determine the winner." },
      ...
      { question: "Can I participate alone or do I have to be in a team?", answer: "You can participate alone: creating a team with a single participant is allowed. If you prefer to join others, use the invite code to join an existing team." },
      { question: "Can I modify/update the final submission after sending it?", answer: "No. The official submission is final: it will not be possible to modify or replace it after sending. Carefully verify the prompts before uploading the final file." },
      { question: "Do prompts have to be written only in Italian?", answer: "Yes, prompts must be in Italian and present relevant cultural elements. You can use slang, neologisms, or words from other languages if properly contextualized in an Italian prompt." },
      { question: "How many prompts can I submit during the challenge?", answer: "During the daily phase you can submit up to 20 prompts per day; for the final submission the format requires exactly 50 prompts. Check the limits in the dashboard before submitting." },
      { question: "Do the results obtained in the Playground affect the leaderboard?", answer: "No. The scores obtained from daily submissions do not contribute to the final leaderboard. The leaderboard is determined using exclusively the 50 prompts from the official submission." },
      { question: "Why do some of my prompts get low scores?", answer: "Prompts can get low scores when they were not able to elicit unethical responses." },
      { question: "Can I upload only the Final Submission?", answer: "Yes. To fulfill participation requirements you must upload the Final Submission. However, you are welcome to use the Playground to test prompts and explore different strategies and themes before submitting your final set of prompts." },
    ] as FaqItem[],
    contactText: "For further questions, send an email to <a class=\"text-indigo-600 underline\" href=\"mailto:lab.mind.unimib@gmail.com\">lab.mind.unimib@gmail.com</a>.",
  },
} as const;
...
export const teamSectionTranslations = {
  ...
  en: {
    ...
    members: {
      ...
      "Giulia Rizzi": { role: "Postdoc Researcher", bio: "Giulia Rizzi is a postdoc researcher. She obtained a Ph.D. in a double PhD in Computer Science at Università degli Studi di Milano - Bicocca (UniMiB) and at Universitat Politècnica de València (UPV). Her research interests are centered in the field of Natural Language Processing and machine learning. She is currently working on a project that focuses on misogyny detection in memes under the Learning With Disagreements paradigm." },
      "Giuseppe Magazzù": { role: "PhD Student", bio: "Giuseppe Magazzù is a 2nd year PhD student. His research focuses on developing an ethical framework and implementing safety strategies to ensure that large language models generate safe, useful, and high-quality outputs. In particular, he is working on designing guardrail methods and benchmarks tailored to the Italian language." },
      "Daniel Scalena": { role: "PhD Student", bio: "Daniel Scalena is a 3rd year PhD student in a cotutelle agreement with University of Groningen. His research focuses mainly on the interpretability of language models, in particular towards their safe and reliable deployment in real-world contexts." },
