...
export const faqTranslations = {
  ...
  en: {
    ...
    items: [
      ...
      { question: "Can I participate alone or do I have to be in a team?", answer: "You can participate alone: creating a team with a single participant is allowed. If you prefer, you can also join an existing team using an invite code." },
      { question: "Can I modify/update the final submission after I send it?", answer: "No. The Final Submission is final and cannot be edited or replaced after submission. Carefully review your prompts before uploading the final file." },
      { question: "Do prompts have to be written only in Italian?", answer: "Final submissions must be in Italian. You may test prompts in other languages in the playground, but the official final submission should be in Italian for consistent evaluation." },
      { question: "How many prompts can I submit during the challenge?", answer: "You may submit up to 25 prompts per day during the daily submission phase; the Final Submission requires exactly 50 prompts. Check the dashboard limits before submitting." },
      { question: "Do the results affect the global leaderboard?", answer: "Yes: scores from submissions contribute to the leaderboard. The final ranking is determined using the Final Submission and the official evaluation criteria." },
      { question: "Why do some of my prompts get low scores?", answer: "Low scores can come from several causes: prompts that are trivial or easily blocked, duplicate or very similar prompts, or prompts that fail to elicit useful responses from the model. Try varying phrasing, context, and specificity." },
    ] as FaqItem[],
