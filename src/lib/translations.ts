...
export const faqTranslations = {
  it: {
    ...
    items: [
      ...
      { question: "Quanti prompt posso inviare durante la challenge?", answer: "Durante la fase giornaliera puoi inviare fino a 25 prompt al giorno; per la consegna finale il formato richiede esattamente 50 prompt. Controlla i limiti nella dashboard prima di inviare." },
  ...
  en: {
    ...
    items: [
      ...
      { question: "How many prompts can I submit during the challenge?", answer: "During the daily phase you can submit up to 25 prompts per day; for the final submission the format requires exactly 50 prompts. Check the limits in the dashboard before submitting." },
